...
class Ui_Dialog1(object):
    def setupUi(self, Dialog):
        ...
        self.sueldouf.setGeometry(QtCore.QRect(320, 170, 133, 16))
        ...
        self.sueldos.setGeometry(QtCore.QRect(320, 150, 133, 16))
        font = QtGui.QFont()
        font.setFamily("Yu Gothic")
        ...
        self.label_5.setGeometry(QtCore.QRect(460, 150, 16, 16))
        font = QtGui.QFont()
        font.setFamily("Yu Gothic")
        font.setPointSize(9)
        ...
        self.label_6.setGeometry(QtCore.QRect(460, 170, 31, 16))
        font = QtGui.QFont()
        font.setFamily("Yu Gothic")
        self.label_6.setFont(font)
        self.label_6.setObjectName("label_6")
        self.saldocartola = QtWidgets.QLineEdit(Dialog)
        self.saldocartola.setGeometry(QtCore.QRect(320, 200, 132, 16))
        self.saldocartola.setObjectName("saldocartola")
        self.label_7 = QtWidgets.QLabel(Dialog)
        self.label_7.setGeometry(QtCore.QRect(460, 200, 16, 16))
        font = QtGui.QFont()
        font.setFamily("Yu Gothic")
        font.setPointSize(9)
        ...
        self.apvfinal.setGeometry(QtCore.QRect(430, 450, 121, 20))
        font = QtGui.QFont()
        font.setFamily("Yu Gothic")
        ...
        self.sueldoapv.setGeometry(QtCore.QRect(320, 240, 132, 16))
        self.sueldoapv.setObjectName("sueldoapv")
        self.label_10 = QtWidgets.QLabel(Dialog)
        self.label_10.setGeometry(QtCore.QRect(460, 290, 16, 16))
        font = QtGui.QFont()
        font.setFamily("Yu Gothic")
        font.setPointSize(9)
        ...
        self.apvmensual.setGeometry(QtCore.QRect(320, 290, 132, 16))
        ...
        self.fechaconsulta = QtWidgets.QDateEdit(Dialog)
        self.fechaconsulta.setGeometry(QtCore.QRect(320, 110, 61, 21))
        font = QtGui.QFont()
        font.setFamily("Yu Gothic")
        self.fechaconsulta.setFont(font)
        self.fechaconsulta.setObjectName("fechaconsulta")
        ...
        self.gridLayout.addWidget(self.labela, 9, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.labela_3, 4, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.labelf, 10, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.labela_2, 5, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.apva, 6, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.apv, 7, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.labelf_2, 11, 0, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.fechaconsulta.setDisplayFormat(_translate("Dialog", "MM-yyyy"))
        self.labela.setText(_translate("Dialog", "8.          AFP"))
        ...
        self.labelf.setText(_translate("Dialog", "9.          Fondo"))
        self.labela_2.setText(_translate("Dialog", "5.          Saldo Cartola"))
        self.label.setText(_translate("Dialog", "1.          Sexo (H o M)"))
        self.label_12.setText(_translate("Dialog", "3.          Mes y año de consulta"))
        self.apva.setText(_translate("Dialog", "6.          Saldo cuenta APV"))
        self.apv.setText(_translate("Dialog", "7.          APV mensual"))
